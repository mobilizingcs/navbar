    ...
    logged_in: function(){
      ...
      oh.user.whoami().done(function(username){
        ...
        oh.user.read({user_list : username}).done(function(r){
		  ...
		  user_details['permissions']['can_create_classes'] ? $("#a[href='#shiny?username=unknown0']").attr("href", "#shiny?admin=true") : $("#a[href='#shiny?username=unknown0']").attr("href", "#shiny?username=idle");
