define([
  ...
  'config/idslongbeach',
  'config/idsportal'
], function($, _, Backbone, vent, oh, oldohmageConfig, ohmageConfig, mobilizeConfig, mobilizelabsConfig, mobilizeInABoxConfig, idsConfig, idscentinelaConfig,idslongbeachConfig,idsportalConfig){
  ...
  switch (location.hostname) {
    case 'portal.idsucla.org':
    case 'portal.mobilizingcs.org':
    case 'portal2.idsucla.org':
    case 'portal2.mobilizingcs.org':
      config = idsportalConfig;
      break;
